...
async function main() {
  ...
  const events = [
    {
      title: "Docker fundamentals & Cloud deployment Workshop",
      description: "A hands-on introductory guide to containerizing applications with Docker and deploying them on Google Cloud.",
      date: new Date("2026-05-11T19:00:00+03:00"),
      location: "Cocoon Tree",
      locationLink: "",
      type: "Workshop",
      rsvpLink: "",
    },
    {
      title: "the human edge Workshop",
      description: "An insightful technical session delivered by Joud AlRimi exploring interaction systems and the hidden mechanisms behind user experience design.",
      date: new Date("2026-05-21T15:00:00+03:00"),
